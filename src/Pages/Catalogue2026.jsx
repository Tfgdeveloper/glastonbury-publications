...
function Catalogue2026() {
  ...
  return (
    <div>
      <Autopopup />
      <SEO
        title="Glastonbury Publications 2026 Catalogue | Featured Books" 
        description="Explore the Glastonbury Publications 2026 Catalogue featuring remarkable books, diverse authors, compelling stories, and publishing services." 
        keyword="Glastonbury Publications 2026 Catalogue"
        focusKeyword="Glastonbury Publications 2026 Catalogue"
        />
        <UpperHeader/>
        <HeroSection
      welcomeText = ""
