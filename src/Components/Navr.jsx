...
const Navr = () => {
  ...
  return (
    <ul className="space-x-10 relative z-[9999]">
      <li
        className="mb-3 rounded font-bold text-[18px] font-[Lora] font-serif transition hover:bg-gradient-to-br hover:from-[#3b6635] hover:to-[#2d6588] hover:bg-clip-text hover:text-transparent"
        ...
        <AnimatePresence>
          {isServicesOpen && (
            <motion.ul
              ...
              className="absolute top-full left-0 w-60 bg-[#EAE9E9] rounded-xl shadow-lg text-black font-normal font-sans z-[9999]"
            >
              <li
                className="px-4 py-2 hover:bg-[linear-gradient(144deg,#3b6635,#2d6588)] hover:text-white rounded-t-xl"
                style={{ fontFamily: "Lora, serif", fontStyle: "normal", fontWeight: 700 }}
              >
                <Link to="/publishing-solutions">Publishing Solutions</Link>
              </li>
              <li
                className="px-4 py-2 hover:bg-[linear-gradient(144deg,#3b6635,#2d6588)] hover:text-white"
                style={{ fontFamily: "Lora, serif", fontStyle: "normal", fontWeight: 700 }}
              >
              ...
              <li
                className="px-4 py-2 hover:bg-[linear-gradient(144deg,#3b6635,#2d6588)] hover:text-white rounded-b-xl"
                style={{ fontFamily: "Lora, serif", fontStyle: "normal", fontWeight: 700 }}
              >
        ...
        <AnimatePresence>
          {isMarketingOpen && (
            <motion.ul
              ...
              exit="hidden"
              variants={dropdownVariants}
              className="absolute top-full left-0 w-72 bg-[#EAE9E9] rounded-xl shadow-lg text-black font-normal font-sans z-[9999]"
            >
      ...
      {/* <li
        className="py-2 rounded font-bold text-[18px] font-[Lora] font-serif transition hover:bg-gradient-to-br hover:from-[#3b6635] hover:to-[#2d6588] hover:bg-clip-text hover:text-transparent"
        style={{ fontFamily: "Lora, serif", fontStyle: "normal", fontWeight: 700 }}
      >
