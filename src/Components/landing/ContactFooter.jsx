...
const ContactFooter= () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full space-y-4 space-x-2 flex flex-col justify-center items-center">
  ...
  className="w-full border-b border-[#fff] text-white bg-transparent focus:outline-none placeholder:text-gray-200 my-8"
      />
