...
const TESTIMONIALS = [
  { quote: "I never thought publishing on Amazon could be this smooth. Glastonbury Publications handled the formatting, keywords, and categories — my book hit the charts within weeks.", author: "— Daniel R" },
  { quote: "They knew exactly how to position my book on Amazon. The visibility I gained with their guidance was incredible.", author: "— Sophia L" },
  { quote: "Professional, transparent, and results-driven. My novel looks amazing on Kindle and in print — couldn’t be happier.", author: "— Michael J" },
  { quote: "From account setup to launch day, they handled A+ Content, pricing, and a flawless Kindle/paperback build. Sales came in faster than any of my previous releases.", author: "— Jordan M" },
   { quote: "Their category research and keyword mapping were spot-on. I finally showed up in the right browse nodes and found my readers.", author: "— Priya K" },
   { quote: "Clear timelines, quick revisions, and a cover that actually converts. Glastonbury Publications made KDP ads and metadata feel easy.", author: "— Trevor S" },
  // add more…
];
