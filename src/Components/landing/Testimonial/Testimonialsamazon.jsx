...
const TESTIMONIALS = [
  { quote: "I never thought publishing could be this smooth. Glastonbury Publications handled the formatting, keywords, and categories — my book gained visibility and started selling within weeks.", author: "— Daniel R" },
  { quote: "They knew exactly how to position my book for success. The visibility I achieved with their guidance was incredible.", author: "— Sophia L" },
  { quote: "Professional, transparent, and results-driven. My novel looks amazing in both digital and print editions — couldn’t be happier.", author: "— Michael J" },
  { quote: "From setup to launch day, they managed everything — content optimization, pricing, and a flawless publishing rollout. Sales came in faster than with any of my previous releases.", author: "— Jordan M" },
   { quote: "Their category research and keyword strategy were spot-on. I finally reached the right audience and found my readers.", author: "— Priya K" },
   { quote: "Clear timelines, quick revisions, and a cover that actually converts. Glastonbury Publications made book marketing and metadata optimization feel effortless.", author: "— Trevor S" },
  // add more…
];
...
export default function Testimonialsamazon() {
