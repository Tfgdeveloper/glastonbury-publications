...
const TESTIMONIALS = [
  { quote: "Draft2Digital gave me reach, but Glastonbury Publications gave me strategy. My book now sells across multiple online stores.", author: "— Adrian P" },
  { quote: "They polished my manuscript and handled all the technical details for Draft2Digital. Publishing was seamless.", author: "— Nina G" },
  { quote: "I never realized how important metadata was until they optimized mine. My sales jumped within the first month.", author: "— Leo H" },
  { quote: "I wanted wide distribution but didn’t know where to start. Glastonbury Publications guided me through Draft2Digital and got my book into stores I’d never considered.", author: "— Melissa R" },
   { quote: "The team made Draft2Digital effortless — from formatting to placement. Now my book is available on platforms I didn’t even know existed.", author: "— Jordan S" },
   { quote: "Their expertise turned a confusing process into a clear strategy. With Glastonbury Publications and Draft2Digital, my book finally has the visibility it deserves.", author: "— Ethan L" },
  // add more…
];
...
export default function Testimonialsdraft() {
