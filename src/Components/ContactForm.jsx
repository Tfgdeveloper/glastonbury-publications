...
const ContactForm = () => {
  ...
  className="w-full rounded-[20px] border border-[#00000033] border-opacity-20 bg-[#EAE9E9] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-3"
      ...
      <button
        type="submit"
        className="ml-auto bg-[#0A2342] text-white hover:border-2 hover:border-[#0A2342] hover:bg-transparent hover:text-[#0A2342] font-bold py-3 px-8 rounded-full transition-colors duration-200 whitespace-nowrap"
